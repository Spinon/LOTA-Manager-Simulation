        ...
        <section className="data-card">
          ...
          <MetricGroup
            ...
            items={[
              ...
              ['Chase', combatBoard?.scenario && combatBoard.phase === 'chase' ? `${combatBoard.scenario.chaseAllowed ? 'Sim' : 'Nao'} / ${Math.round(combatBoard.scenario.chaseScore)}` : '-'],
              ['Formacao', combatBoard?.scenario ? `${Math.round(combatBoard.scenario.formationIntegrity * 100)}%` : '-'],
              ['Counter', combatBoard?.scenario ? `${Math.round(combatBoard.scenario.counterInitiationOpportunity)} / ${Math.round(combatBoard.scenario.counterInitiationRisk)}` : '-'],
      ...
      <div className="detail-panel unit-detail">
        ...
        <MetricGroup
          ...
          items={[
            ...
            ['Res. magica', `${entity.magicResistance.toFixed(0)}%`],
